...
int readPerturbData(struct perturb_data *data, struct units *us,
                    struct perturbs *pt, struct background *ba) {
...
int run_class(struct perturb_data *data, struct units *us, 
    ...
    struct file_content fc; /* for file contents */
    struct precision pr; /* for precision parameters */
    struct background ba; /* for cosmological background */
    struct thermo th; /* for thermodynamics */
    struct perturbs pt; /* for source functions */
    struct transfers tr; /* for transfer functions */
    struct primordial pm; /* for primordial functions */
    struct spectra sp; /* for harmonic spectra */
    struct nonlinear nl; /* for nonlinear aspects */
    struct lensing le; /* for lensing */
    ...
    if (input_init_from_arguments(class_argc, class_argv, &pr, &ba, &th,
            &pt, &tr, &pm, &sp, &nl, &le, &op, errmsg)  == _FAILURE_) {
